...
\begin{itemize}
    \item \textbf{Target Incident Root:} \texttt{\small 0x04b21735E93Fa3f8df70e2Da89e6922616891a88} \\ (WazirX Compromised Hot Wallet).
...
\begin{enumerate}
    ...
    \item \textbf{Layer 3 (Mixer Offloading):} At hop depth $d=3$, the Priority Search flagged direct deposit transactions into the verified \textbf{Tornado.Cash 100 ETH Accumulator Contract} (\texttt{\small 0xd90e2f925da726b50c4ed8d0fb90ad053324f31b}). The composite risk score for destination nodes escalated immediately to $\text{Risk} = 100$.
...
\begin{itemize}
    \item \textbf{Target Root Address:} \texttt{\small 0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045} (vitalik.eth).
...
\begin{itemize}
    \item \textbf{Target Root Address:} Base58 TRON Address \\ \texttt{\small TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t} (Tether TRC-20 Gateway).
