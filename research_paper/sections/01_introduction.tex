...
\begin{enumerate}
    \item \textbf{Formal Graph-Theoretic Formulation of Dynamic Account Networks:} We define the multi-token transaction graph as a directed multigraph with continuous temporal attributes and multi-asset balance states, formalizing the laws of taint propagation and volume dilution under arbitrary splitting ratios.
